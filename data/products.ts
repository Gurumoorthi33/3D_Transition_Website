...
export const products: Product[] = [
    {
        ...
        folderPath: "/images/mango", // Mapped to our local assets
        themeColor: "#FFB74D",
        gradient: "linear-gradient(to bottom, #FFB74D, #FFA726)",
    ...
    },
    {
        ...
        themeColor: "#8D6E63",
        gradient: "linear-gradient(to bottom, #8D6E63, #5D4037)",
    ...
    },
    {
        ...
        themeColor: "#E57373",
        gradient: "linear-gradient(to bottom, #E57373, #C62828)",
